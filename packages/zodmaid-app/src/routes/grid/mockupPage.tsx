    ...
    <div className="min-h-dvh bg-gray-100 text-gray-900 p-4">
      ...
      <Row>
        <Cell variant="yellow">
          <div className="flex gap-1 items-start">
            <div className="flex gap-1 items-center">
              <JsonType variant="primitive">{jsonTypes.formula}</JsonType>
      ...
      <Row>
        <Cell>
          <div className="flex gap-1 items-start">
            <div className="flex gap-1 items-center">
              <JsonType variant="primitive">{jsonTypes.string}</JsonType>
        ...
        <Cell>
          <div className="flex gap-1 items-start">
            <div className="flex gap-1 items-center">
              <JsonType variant="primitive">{jsonTypes.number}</JsonType>
        ...
        <Cell>
          <div className="flex gap-1 items-start">
            <div className="flex gap-1 items-center">
              <JsonType variant="primitive">{jsonTypes.boolean}</JsonType>
        ...
        <Cell>
          <div className="flex gap-1 items-start">
            <div className="flex gap-1 items-center">
              <JsonType variant="primitive">{jsonTypes.null}</JsonType>
        ...
        <Cell>
          <div className="flex gap-1 items-start">
            <div className="flex gap-1 items-center">
              <JsonType variant="primitive">{jsonTypes.money}</JsonType>
        ...
        <Cell>
          <div className="flex gap-1 items-start">
            <div className="flex gap-1 items-center">
              <JsonType variant="primitive">{jsonTypes.date}</JsonType>
